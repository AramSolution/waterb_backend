...
/**
 * ARMUSER 등록 요청 DTO (공통)
 * esntlId는 화면 입력 없음, 등록 시 서버에서 항상 채번
 */
@Data
public class ArmuserInsertRequest {

    /** 고유ID (화면에서 받지 않음, 등록 시 서버 채번) */
