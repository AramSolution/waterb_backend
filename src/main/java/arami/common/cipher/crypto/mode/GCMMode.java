...
import arami.common.cipher.crypto.BlockCipherModeAE;

import java.io.ByteArrayOutputStream;
import java.util.Arrays;

import static arami.common.cipher.crypto.util.Ops.XOR;
import static arami.common.cipher.crypto.util.Ops.shiftRight;
import static arami.common.cipher.crypto.util.Pack.intToBigEndian;
import static arami.common.cipher.crypto.util.Pack.longToBigEndian;
