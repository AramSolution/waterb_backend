...
public class KISA_SEED_CBC {
	...
	public static int SEED_CBC_init( KISA_SEED_INFO pInfo, KISA_ENC_DEC enc, byte[] pbszUserKey, byte[] pbszIV ) {
		int ABCD[] = new int[4];			// Iuput/output values at each rounds(�? ?��?��?�� ?��/출력)
...
//                (byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C, (byte)0x0D, (byte)0x0E, (byte)0x0F};
		...
		int process_blockLeng = BLOCK_SIZE_SEED * 2;								//?��번에 처리?�� BLOCK
		...
		process_blockLeng = BLOCK_SIZE_SEED * 2;								//?��번에 처리?�� BLOCK
